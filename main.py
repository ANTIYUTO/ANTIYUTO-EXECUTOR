...
Credits.Text = "@yutorichi.geme"
Credits.TextColor3 = Color3.fromRGB(0, 0, 0)
Credits.TextScaled = true
Credits.TextSize = 14.000
Credits.TextWrapped = true

e1x1x1x1Message.Name = "ANTIYUTO_OFICIAL"
...
e1x1x1x1Message.MouseButton1Down:connect(function()
	while true do
		...
		msg.Text ="ANTIYUTO//PROTECTOR DE ROBLOX"
		wait(6)
		msg:remove()
		wait(3)
		msg = Instance.new("Message")
		msg.Parent = game.Workspace
		msg.Text = "ANTIYUTO EL MEJOR PROTECTOR DE ROBLOX "
		wait(6)
		msg:remove()
		wait(3)
		msg = Instance.new("Message")
		msg.Parent = game.Workspace
		msg.Text = "Y SI ERES HACKER TE DESTRUIRTE HAHAHAHA"
		wait(6)
		msg:remove()
		wait(3)
		msg = Instance.new("Message")
		msg.Parent = game.Workspace
		msg.Text = "TE DESTRUIRE HACKER DE TEMU HAHAHAHA"
		wait(6)
		msg:remove()
		wait(3)
		msg = Instance.new("Message")
		msg.Parent = game.Workspace
		msg.Text = "NUNCA PODRÁS GANARME Y SOPORTA"
		wait(6)
		msg:remove()
		wait(3)
		msg = Instance.new("Message")
		msg.Parent = game.Workspace
		msg.Text = "ATENTAMENTE ANTIYUTO EL MÁS PERRO DEVORADOR HAHAHA"
		wait(6)
		msg:remove()
		wait(3)
		msg = Instance.new("Message")
		msg.Parent = game.Workspace
		msg.Text = "TE HACKEARE SI ERES UN HACKER QUE EXPLOTA JUEGOS"
		wait(6)
		msg:remove()
	end
end)
e1x1x1x1Music.Name = "music"
...
e1x1x1x1Laugh.Name = "ANTIYUTO TU PATRÓN!!!"
